...
export const BARCWAY_FOUNDERS: FounderDetail[] = [
  {
...
// SERVICES FROM CENTRA ARYA LOKA (Presented with Barcway luxury studio aesthetic)
...
// PROJECTS CURATED (BARCWAY STYLE + SURABAYA MASTERPIECES)
